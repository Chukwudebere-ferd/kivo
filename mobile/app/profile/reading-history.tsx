...
import { readingHistory } from "../../lib/mock-data";
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.bg }}>
      <View style={[s.header, { backgroundColor: theme.bg }]}>
        ...
        <Text style={[s.title, { color: theme.text }]}>Reading History</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      {readingHistory.length === 0 ? (
        <View style={s.emptyState}>
          ...
          <Text style={[s.emptyText, { color: theme.textMuted }]}>No reading history yet</Text>
        </View>
      ) : (
